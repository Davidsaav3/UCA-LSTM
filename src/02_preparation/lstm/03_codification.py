...
# PARÁMETROS 
INPUT_FILE = '../../../results/02_preparation/02_nulls.csv'          # ARCHIVO DE ENTRADA DEL DATASET ORIGINAL
OUTPUT_FILE = '../../../results/02_preparation/03_codification.csv'  # ARCHIVO DE SALIDA DEL DATASET PROCESADO
AUX_FILE = '../../../results/02_preparation/03_aux.json'             # ARCHIVO JSON PARA REGISTRAR CAMBIOS REALIZADOS
