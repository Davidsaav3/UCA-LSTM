...
# PARÁMETROS 
INPUT_FILE = '../../../results/02_preparation/03_codification.csv'  # CSV DE ENTRADA YA CODIFICADO
OUTPUT_FILE = '../../../results/02_preparation/04_scale.csv'        # CSV ESCALADO QUE SE GUARDARÁ
