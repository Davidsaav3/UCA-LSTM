...
# PARÁMETROS
INPUT_CSV = '../../../results/02_preparation/05_variance.csv'  # DATASET FINAL TRAS VARIANZA
OUTPUT_CSV = '../../../results/02_preparation/06_sequences.csv'  # CSV CON SECUENCIAS GENERADAS
