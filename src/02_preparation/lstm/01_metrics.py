...
# PARÁMETROS 
INPUT_FILE = '../../../results/01_dataset/context_data_realtime.csv'                # RUTA DEL DATASET DE ENTRADA
OUTPUT_FILE = '../../../results/02_preparation/01_metrics.csv'  # RUTA DEL CSV DE SALIDA
