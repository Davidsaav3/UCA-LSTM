...
RESULTS_DIR = '../../../results/02_preparation'   # CARPETA PRINCIPAL DONDE SE GUARDAN TODOS LOS LOGS Y RESULTADOS
...
SCRIPTS = [
    ...
    {'name': '06_sequences.py', 'active': True},      # generar secuencias temporales con ventanas (timesteps)
