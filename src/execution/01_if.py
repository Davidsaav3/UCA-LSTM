...
INPUT_CSV = '../../results/execution/01_contaminated.csv'     
OUTPUT_CSV = os.path.join(EXECUTION_FOLDER, '01_if.csv')  
OUTPUT_IF_CSV = os.path.join(EXECUTION_FOLDER, '01_if_anomaly.csv')   
