...
# CONFIGURACIÓN
# -------------------------
YEAR = 2018   # <<-- CAMBIA AQUÍ EL AÑO QUE QUIERAS

# URL de la API
url = "https://openapi.kunna.es/01_dataset/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3NDkxMjA5NDh9.uq7VGKS8A7tWoFQNXspGfBdhhVBb4YbJOBxJ-2AvMGs"
