...
# CONFIGURACIÓN
# -------------------------
YEAR = 2025   # <<-- CAMBIA AQUÍ EL AÑO QUE QUIERAS

# URL de la API
url = "https://openapi.kunna.es/01_dataset/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3NTkwNzMzMDF9.fNGIwMkYZQlfkX1ZaDcag2CcGrjMZPQbXIVkUhRgMUI"
...
output_file = f"autoconsumo{YEAR}.json"
