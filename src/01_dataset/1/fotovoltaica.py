...
# URL de la API
url = "https://openapi.kunna.es/01_dataset/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3NTkwNzMyNDd9.xYrbddQGBQHFiygVjXEGJ3UXEpZcAJqr6i4Qt40LDgw"
...
output_file = f"fotovoltaica{YEAR}.json"
