...
# CONFIGURACIÓN
# -------------------------
YEAR = 2024   # <<-- CAMBIA AQUÍ EL AÑO QUE QUIERAS

# URL de la API
url = "https://openapi.kunna.es/01_dataset/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3NTI1MDgwNzJ9.lqTA2UMmqnS7WmY55Tj6chTjf9nRGqHNNtTD9Iux0p4"
