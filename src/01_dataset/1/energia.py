...
# CONFIGURACIÓN
# -------------------------
YEAR = 2021   # <<-- CAMBIA AQUÍ EL AÑO QUE QUIERAS

# URL de la API
url = "https://openapi.kunna.es/01_dataset/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3NTIyMjE1MTB9.bmd-NPy8IovPDYlUQ4H2kGv4U7bWSMKv1MeIWt_9I7A"
...
output_file = f"energia{YEAR}.json"
